        ...
        <div class="mx-auto w-[97%] max-w-[1500px] space-y-6 mb-6">
            ...
            <div class="bg-white border border-gray-200 shadow-md rounded-xl p-6 mt-6">
                                ...
                                @foreach ($fields as $index => $data)
                                    <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                                        ...
                                        <td class="py-3 px-2 text-center">
                                            <span
                                                class="bg-[#13810A] text-white text-sm font-semibold px-3 py-1 rounded-lg shadow">
                                        ...
                                        <td class="py-3 px-2">
                                            <div class="flex w-full justify-center items-center gap-2">
                                                <!-- Tombol Edit -->
                                                <button
                                                    class="editFieldBtn flex items-center gap-1 bg-blue-800 hover:bg-blue-700 text-white text-xs font-medium px-3 py-1.5 rounded-md shadow-sm transition"
                ...
                <div id="editFieldModal"
                    ...
                    <div
                        class="bg-white rounded-xl shadow-lg w-full max-w-[450px] max-h-[90vh] overflow-y-auto relative p-6 flex flex-col">
