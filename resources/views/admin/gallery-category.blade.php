...
@section('content')
    <div class="p-6">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-4 mb-3">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">Kategori Galeri</h1>
                    <p class="text-gray-600 mt-1">Kelola kategori untuk pengelompokan foto galeri</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white border border-gray-200 shadow-xl rounded-2xl p-6 h-fit sticky top-6">
                    ...
                    <form action="{{ route('admin.gallery-categories.store') }}" method="POST" class="space-y-5"
                        data-no-loader>
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" placeholder="Contoh: Turnamen, Event, Fasilitas"
                            ...
                            <p class="text-xs text-gray-500 mt-2">Masukkan nama kategori untuk pengelompokan foto galeri</p>
                        </div>
                        ...
                        <table class="w-full">
                            <thead class="bg-gray-50">
                                <tr class="border-b border-gray-200">
                                    ...
                                    <th class="py-4 px-6 text-left">
                                        <span class="text-xs font-semibold text-gray-600 uppercase tracking-wider">Jumlah
                                            Foto</span>
                                    </th>
                                    <th class="py-4 px-6 text-left">
                                        <span
                                ...
                                @forelse ($categories as $index => $category)
                                    <tr class="hover:bg-gray-50 transition-colors duration-150"
                                        ...
                                        <td class="py-4 px-6">
                                            <div class="flex items-center gap-3">
                                                <div
                                                    class="w-10 h-10 bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg flex items-center justify-center">
                                        ...
                                        <td class="py-4 px-6">
                                            <div class="flex items-center gap-2">
                                                <!-- Edit Button -->
                                                <button
                                                    class="editGalleryCategoryBtn bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium shadow-sm hover:shadow transition-all duration-200 flex items-center gap-2 group"
                                    ...
                                    <tr>
                                        <td colspan="4" class="py-12 text-center">
                                            <div class="flex flex-col items-center justify-center">
                                                ...
                                                <h3 class="text-lg font-bold text-gray-500 mb-2">Belum ada kategori galeri
                                                </h3>
                                                <p class="text-gray-400 max-w-md text-center">
                                                    Tambahkan kategori pertama Anda untuk mulai mengelompokkan foto galeri
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
    ...
    <!-- Modal Edit Kategori -->
    <div id="editGalleryCategoryModal" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4">
        <!-- Background overlay -->
        <div class="modal-overlay fixed inset-0 bg-gray-900 bg-opacity-50 backdrop-blur-sm"></div>
        <!-- Modal panel -->
        <div
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-gray-800">Edit Kategori Galeri</h3>
                        <p class="text-gray-600 text-sm mt-1">Perbarui informasi kategori galeri</p>
                    </div>
                </div>
                <button type="button"
                    class="btn-close-gallery-category text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg p-1">
            ...
            <form action="" method="POST" id="editGalleryCategoryForm">
                ...
                <div class="flex justify-end gap-3 pt-6 border-t border-gray-200">
                    <button type="button"
                        class="btn-close-gallery-category px-5 py-2.5 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg font-medium">
                        Batal
                    </button>
                    <button type="submit"
